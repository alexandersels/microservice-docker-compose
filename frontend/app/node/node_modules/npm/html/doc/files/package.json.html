...
<p>For GitHub, GitHub gist, Bitbucket, or GitLab com.test.project.userservice.repositories you can use the same
...
to publish it.</p>
<p>This is a way to prevent accidental publication of private com.test.project.userservice.repositories.  If
...
<p id="footer">package.json &mdash; npm@6.12.0</p>
