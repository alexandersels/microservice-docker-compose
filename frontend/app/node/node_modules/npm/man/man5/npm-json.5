...
.P
For GitHub, GitHub gist, Bitbucket, or GitLab com.test.project.userservice.repositories you can use the same
...
to publish it\.
.P
This is a way to prevent accidental publication of private com.test.project.userservice.repositories\.  If
