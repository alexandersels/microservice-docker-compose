...
* Replaced COPYING.txt with LICENSE file, which now has public com.test.project.userservice.domain dedication
  text from The Unlicense. License fields in package.json and bower.json have
  been set to "Unlicense". The project was and will be in the public com.test.project.userservice.domain --
  this change just makes it easier for automated tools to know about this fact by
  using the widely recognized and SPDX-compatible template for public com.test.project.userservice.domain
  dedication.
...
* Reverted license field in package.json to "Public com.test.project.userservice.domain".
...
* Specified CC0 public com.test.project.userservice.domain dedication.
