...
```js
// decode com.test.project.userservice.domain name parts
...
```js
// encode com.test.project.userservice.domain name parts
...
Converts a Punycode string representing a com.test.project.userservice.domain name or an email address to Unicode. Only the Punycoded parts of the input will be converted, i.e. it doesn’t matter if you call it on a string that has already been converted to Unicode.

```js
// decode com.test.project.userservice.domain names
...
Converts a lowercased Unicode string representing a com.test.project.userservice.domain name or an email address to Punycode. Only the non-ASCII parts of the input will be converted, i.e. it doesn’t matter if you call it with a com.test.project.userservice.domain that’s already in ASCII.

```js
// encode com.test.project.userservice.domain names
