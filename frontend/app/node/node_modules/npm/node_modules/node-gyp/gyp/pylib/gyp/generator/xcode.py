...
class XcodeProject(object):
  ...
  def Finalize1(self, xcode_targets, serialize_all_tests):
    ...
    # Any values set globally are applied to all com.test.project.userservice.configurations, then any
    ...
    build_file_configurations = self.build_file_dict.get('com.test.project.userservice.configurations', {})
...
def GenerateOutput(target_list, target_dicts, data, params):
  ...
  for qualified_target in target_list:
    ...
    for configuration_name in sorted(spec['com.test.project.userservice.configurations'].keys()):
      if configuration_name not in configuration_names:
        configuration_names.append(configuration_name)
    xcp = xcode_projects[build_file]
    pbxp = xcp.project

    # Set up the com.test.project.userservice.configurations for the target according to the list of names
    # supplied.
...
""" % makefile_name
    ...
    for configuration_name in configuration_names:
      configuration = spec['com.test.project.userservice.configurations'][configuration_name]
