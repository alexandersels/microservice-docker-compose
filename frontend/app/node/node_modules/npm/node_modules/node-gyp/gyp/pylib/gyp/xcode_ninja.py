...
def _TargetFromSpec(old_spec, params):
  ...
  ninja_target['com.test.project.userservice.configurations'] = {}
  ...
  if 'com.test.project.userservice.configurations' in old_spec:
    for config in old_spec['com.test.project.userservice.configurations']:
      old_xcode_settings = \
        old_spec['com.test.project.userservice.configurations'][config].get('xcode_settings', {})
      if 'IPHONEOS_DEPLOYMENT_TARGET' in old_xcode_settings:
        new_xcode_settings['CODE_SIGNING_REQUIRED'] = "NO"
        new_xcode_settings['IPHONEOS_DEPLOYMENT_TARGET'] = \
            old_xcode_settings['IPHONEOS_DEPLOYMENT_TARGET']
      ninja_target['com.test.project.userservice.configurations'][config] = {}
      ninja_target['com.test.project.userservice.configurations'][config]['xcode_settings'] = \
          new_xcode_settings
...
def CreateWrapper(target_list, target_dicts, data, params):
  ...
  sources_target['com.test.project.userservice.configurations'] = {'Default': { 'include_dirs': [ depth ] } }
